...
Official implementation for **"Recursive Video Lane Detection"** [[arxiv]](https://drive.google.com/file/d/1Lz9hWGL12Rm_KHsN3roCkwhh2FvbrREJ/view?usp=sharing) [[supp]](https://drive.google.com/file/d/1Lz9hWGL12Rm_KHsN3roCkwhh2FvbrREJ/view?usp=sharing)
...
### Video
<a href="https://www.youtube.com/watch?v=Z0FaOqVrN5w" target="_blank"><img src="https://img.youtube.com/vi/Z0FaOqVrN5w/0.jpg" alt="Video" width="30%" height="30%" /></a>
<a href="https://www.youtube.com/watch?v=rTeyZDXBW1I" target="_blank"><img src="https://img.youtube.com/vi/rTeyZDXBW1I/0.jpg" alt="Video" width="30%" height="30%" /></a>
...
### Directory structure
    ...
    │   ├── VIL-100             # dataset name (VIL-100, OpenLane-V)
    |   |   ├── ILD_seg         # ILD part for predicting binary segmentation maps
    |   |   |   ├── code
    |   |   ├── ILD_coeff       # ILD part for predicting coefficient maps
    |   |   |   ├── code
    |   |   ├── PLD             # PLD
    |   |   |   ├── code
    │   ├── OpenLane-V           
